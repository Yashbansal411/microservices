...
import com.example.booking.entity.ErrorResponse;
import com.example.booking.exception.BookAlreadyIssued;
import com.example.booking.exception.BookNotFound;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     */
    @ExceptionHandler(value = {BookAlreadyIssued.class, BookNotFound.class, FineGreaterThanZero.class,
